...
@triton.testing.perf_report(
    ...
    triton.testing.Benchmark(
        ...
        styles=[("blue", "-"), ("green", "-")],
        ylabel="time (ms)",
        plot_name=f"moe-fwd-fp16-speed-benchmark",
        # args={"dtype": torch.bfloat16, "mode": mode, "seq_len": 2048},
        args={"seq_len": 2048, "hidden_size": 4096, "intermediate_size": 14336, "num_local_experts": 8, "num_experts_per_tok": 2, "dtype": torch.float16, "mode": "forward"},
    ),
    # triton.testing.Benchmark(
    #     x_names=["bsz"],
    #     x_vals=[i for i in range(4, 8, 2)],
    ...
    #     styles=[("blue", "-"), ("green", "-")],
    #     ylabel="time (ms)",
    #     plot_name=f"moe-fwd-fp32-speed-benchmark",
    #     # args={"dtype": torch.bfloat16, "mode": mode, "seq_len": 2048},
    #     args={"seq_len": 2048, "hidden_size": 4096, "intermediate_size": 14336, "num_local_experts": 8, "num_experts_per_tok": 2, "dtype": torch.float32, "mode": "forward"},
    # ),
    # triton.testing.Benchmark(
    #     x_names=["bsz"],
